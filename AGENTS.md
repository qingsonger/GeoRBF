...
reviewable, reproducible, and tied to exactly one atomic requirement or one
...
3. Read this file, the requirement registry, current progress, relevant ADRs,
...
6. Update documents, examples, schemas or API snapshots, diagnostics, and a
   changelog fragment.
7. Run relevant focused checks and the standard workspace checks.
8. Update `requirements/v1.yaml` and `docs/progress/CURRENT.md` accurately.
...
Mathematical or numerical changes require an independent review covering
