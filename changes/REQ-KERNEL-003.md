...
Independent 90-digit truth, finite differences, deterministic random SPD and
projected-CPD checks, center limits, exchange signs, tensor symmetry, extreme
exponential and rational tails, pathologies, compile-fail dimensions, and
thread-safety assertions cover the new runtime paths. A runnable example and
deterministic allocation-free benchmark accompany the Rust API.
